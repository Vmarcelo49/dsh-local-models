...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function LocalModelsSection() {
			...
			var TABS = ["profiles", "router", "model", "estimate"];
			...
			if (estimate) tabDefs.push({ id: "estimate", label: "VRAM estimate" });
			// Stale tab (e.g. estimate picked, then the model unpicked) falls back to Model.
			var effTab = tab === "estimate" && !estimate ? "model" : tab;
			var tabBar = h(
				"div",
